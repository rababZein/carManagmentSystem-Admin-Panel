  ...
  export default {
    ...
    methods: {
      initialize () {
        ...
        // fill data
        this.$api.get(`${process.env.VUE_APP_API_ENDPOINT}admin/car_type`, {
      ...
      deleteItem (item) {
        ...
        if (answer) {
          this.$api.delete(`${process.env.VUE_APP_API_ENDPOINT}admin/car_type/${item.id}`,
          {
            headers: {Authorization: 'Bearer ' + localStorage.getItem('token')}
          })
          .then(response => {
      ...
      save () {
        ...
        if (this.editedIndex > -1) {
          this.$api.patch(`${process.env.VUE_APP_API_ENDPOINT}admin/car_type/${this.editedItem.id}`,
          {
          ...
          this.$api.post(`${process.env.VUE_APP_API_ENDPOINT}admin/car_type`,
          {
            name: this.editedItem.name,
            description: this.editedItem.description
          },
